...
const subscriber = new AlgorandSubscriber(config, algorand.client.algod, algorand.client.indexer)
```
...
`arc28Events` are any [ARC-28 event definitions](../subscriptions/#arc28eventgroup).
