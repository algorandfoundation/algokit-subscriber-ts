...
Version 3 of this library targets `algosdk@3` and `@algorandfoundation/algokit-utils@9`. Both are peer dependencies, so
install them alongside the subscriber using your favourite npm client, e.g.:
