...
export type VotingRoundApp = {
  ...
  methods:
    ...
    & Record<'create(string,uint8,byte[],string,uint64,uint64,uint8[],uint64,string)void' | 'create', {
      ...
      argsTuple: [voteId: string, voteType: number, snapshotPublicKey: Uint8Array, metadataIpfsCid: string, startTime: bigint | number, endTime: bigint | number, optionCounts: number[], quorum: bigint | number, nftImageUrl: string]
      returns: void
    }>
    ...
    & Record<'vote(pay,byte[],uint64,uint8[],uint64[],application)void' | 'vote', {
      ...
      argsTuple: [fundMinBalReq: TransactionToSign | Transaction | Promise<SendTransactionResult>, signature: Uint8Array, weighting: bigint | number, answerIds: number[], answerWeights: bigint | number[], opupApp: number | bigint | undefined]
      returns: void
    }>
  /**
...
export type VotingRoundAppCreateCallParams =
  | (TypedCallParams<'create(string,uint8,byte[],string,uint64,uint64,uint8[],uint64,string)void'> & (OnCompleteNoOp))
/**
...
export abstract class VotingRoundAppCallFactory {
  ...
  static get create() {
    return {
       ...
       */
      create(args: MethodArgs<'create(string,uint8,byte[],string,uint64,uint64,uint8[],uint64,string)void'>, params: AppClientCallCoreParams & CoreAppCallArgs & AppClientCompilationParams & (OnCompleteNoOp) = {}) {
        return {
          method: 'create(string,uint8,byte[],string,uint64,uint64,uint8[],uint64,string)void' as const,
          methodArgs: Array.isArray(args) ? args : [args.voteId, args.voteType, args.snapshotPublicKey, args.metadataIpfsCid, args.startTime, args.endTime, args.optionCounts, args.quorum, args.nftImageUrl],
          ...params,
        }
      },
    }
   ...
   * @returns A TypedCallParams object for the call
   */
  static getPreconditions(args: MethodArgs<'get_preconditions(byte[],uint64,application)(uint64,uint64,uint64,uint64)'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
   ...
   * @returns A TypedCallParams object for the call
   */
  static vote(args: MethodArgs<'vote(pay,byte[],uint64,uint8[],uint64[],application)void'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'vote(pay,byte[],uint64,uint8[],uint64[],application)void' as const,
      methodArgs: Array.isArray(args) ? args : [args.fundMinBalReq, args.signature, args.weighting, args.answerIds, args.answerWeights, args.opupApp],
      ...params,
    }
  }
}
...
export class VotingRoundAppClient {
  ...
  public get create() {
    ...
    return {
       ...
       */
      async create(args: MethodArgs<'create(string,uint8,byte[],string,uint64,uint64,uint8[],uint64,string)void'>, params: AppClientCallCoreParams & AppClientCompilationParams & IncludeSchema & CoreAppCallArgs & (OnCompleteNoOp) = {}) {
        return $this.mapReturnValue<MethodReturn<'create(string,uint8,byte[],string,uint64,uint64,uint8[],uint64,string)void'>, AppCreateCallTransactionResult>(await $this.appClient.create(VotingRoundAppCallFactory.create.create(args, params)))
      },
    }
  }
   ...
   * @returns The result of the call
   */
  public getPreconditions(args: MethodArgs<'get_preconditions(byte[],uint64,application)(uint64,uint64,uint64,uint64)'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
   ...
   * @returns The result of the call
   */
  public vote(args: MethodArgs<'vote(pay,byte[],uint64,uint8[],uint64[],application)void'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
  ...
  public compose(): VotingRoundAppComposer {
    ...
    return {
      opupBootstrap(args: MethodArgs<'opup_bootstrap(pay)uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
        promiseChain = promiseChain.then(() => client.opupBootstrap(args, {...params, sendParams: {...params?.sendParams, skipSending: true, atc}}))
      ...
      getPreconditions(args: MethodArgs<'get_preconditions(byte[],uint64,application)(uint64,uint64,uint64,uint64)'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
      ...
      vote(args: MethodArgs<'vote(pay,byte[],uint64,uint8[],uint64[],application)void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
...
export type VotingRoundAppComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  opupBootstrap(args: MethodArgs<'opup_bootstrap(pay)uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): VotingRoundAppComposer<[...TReturns, MethodReturn<'opup_bootstrap(pay)uint64'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  close(args: MethodArgs<'close(application)void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): VotingRoundAppComposer<[...TReturns, MethodReturn<'close(application)void'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getPreconditions(args: MethodArgs<'get_preconditions(byte[],uint64,application)(uint64,uint64,uint64,uint64)'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): VotingRoundAppComposer<[...TReturns, MethodReturn<'get_preconditions(byte[],uint64,application)(uint64,uint64,uint64,uint64)'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  vote(args: MethodArgs<'vote(pay,byte[],uint64,uint8[],uint64[],application)void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): VotingRoundAppComposer<[...TReturns, MethodReturn<'vote(pay,byte[],uint64,uint8[],uint64[],application)void'>]>
