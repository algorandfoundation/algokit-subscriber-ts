...
export const APP_SPEC: Arc56Contract = {
  ...
  methods: [
    ...
    {
      name: 'close',
      args: [{ name: 'opup_app', type: 'application', defaultValue: { source: 'global', data: 'b3VhaWQ=' } }],
      returns: { type: 'void' },
      events: [],
      actions: { create: [], call: ['NoOp'] },
    },
    {
      ...
      args: [
        ...
        { name: 'opup_app', type: 'application', defaultValue: { source: 'global', data: 'b3VhaWQ=' } },
      ],
...
export type VotingRoundAppComposer<TReturns extends [...any[]] = []> = {
  ...
  readonly delete: {
     ...
     * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
     */
    bare(params?: AppClientBareCallParams): VotingRoundAppComposer<TReturns>
  }
