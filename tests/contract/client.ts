...
export const APP_SPEC: Arc56Contract = {
  ...
  state: {
    ...
    keys: {
      global: {
        value: { keyType: 'AVMString', valueType: 'AVMUint64', key: 'dmFsdWU=' },
        bytes1: { keyType: 'AVMString', valueType: 'AVMBytes', key: 'Ynl0ZXMx' },
        bytes2: { keyType: 'AVMString', valueType: 'AVMBytes', key: 'Ynl0ZXMy' },
        int1: { keyType: 'AVMString', valueType: 'AVMUint64', key: 'aW50MQ==' },
        int2: { keyType: 'AVMString', valueType: 'AVMUint64', key: 'aW50Mg==' },
      },
      local: {
        local_bytes1: { keyType: 'AVMString', valueType: 'AVMBytes', key: 'bG9jYWxfYnl0ZXMx' },
        local_bytes2: { keyType: 'AVMString', valueType: 'AVMBytes', key: 'bG9jYWxfYnl0ZXMy' },
        local_int1: { keyType: 'AVMString', valueType: 'AVMUint64', key: 'bG9jYWxfaW50MQ==' },
        local_int2: { keyType: 'AVMString', valueType: 'AVMUint64', key: 'bG9jYWxfaW50Mg==' },
      },
      box: {},
    },
    maps: { global: {}, local: {}, box: { box: { keyType: 'byte[4]', valueType: 'string', prefix: '' } } },
  },
  bareActions: { create: ['NoOp', 'OptIn'], call: ['DeleteApplication', 'UpdateApplication'] },
  sourceInfo: {
    approval: {
      sourceInfo: [
        { pc: [174], errorMessage: 'Deliberate error' },
        { pc: [113, 134, 152, 170, 178, 196, 211, 240, 269, 293], errorMessage: 'OnCompletion is not NoOp' },
        { pc: [324], errorMessage: 'OnCompletion is not OptIn' },
        { pc: [368], errorMessage: 'can only call when creating' },
        { pc: [116, 137, 155, 173, 181, 199, 214, 243, 272, 296, 327, 351, 359], errorMessage: 'can only call when not creating' },
        { pc: [376], errorMessage: 'unauthorized' },
      ],
      pcOffsetMethod: 'none',
    },
  ...
  byteCode: {
    approval:
      '',
    clear: 'CoEBQw==',
  },
    ...
    box: {
      ...
      box: {
        ...
        getMap: async (): Promise<Map<Uint8Array, string>> => {
          return (await this.appClient.state.box.getMap('box')) as Map<Uint8Array, string>
        },
        /**
         * Get a current value of the box map by key from box state
         */
        value: async (key: Uint8Array): Promise<string | undefined> => {
          return (await this.appClient.state.box.getMapValue('box', key)) as string | undefined
        },
      },
    },
  }
